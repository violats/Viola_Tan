...
Our Solution: <b>Developed concept of AI-driven Itinerary Generation personalised for different target groups/demographics App</b>
...
The presentation in class is from the POV of our DIFK (double-income, (have a) fur kid - a dog) persona as we walked through his use case with Phase 1 of our app.
 ...
 [Feel free to jump to time 5:32 of this video link](https://drive.google.com/file/d/1qJ9URXzf2QoLuzewmQ5GFnrDPt1rK9Et/view?usp=sharing) to see how I Storytell and relate Emotions/values to key features of our app.<br>
 (Aesthetics beautifully designed by team-mate, Soh Kiam Boon.  Ideas in presentation collaboratively generated by group members.)<br><br>
 More reports of how I do this can be seen below in my Skill #2 - Storytell Insight with Emotion/Values.
 
 <i>Skills Developed:</i><br>
 a) Planned app through user interviews, research and transformation into insights<br>
 b) Defined use cases and user journey maps<br>
 b) Designed app through group ideation then evaluating using DVF test<br>
 c) Prototyped and Tested concept with users<br><br>
